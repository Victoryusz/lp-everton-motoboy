document.addEventListener('DOMContentLoaded', function () {
        ...
        window.addEventListener(
            ...
            debounce(function () {
                ...
                header.style.background =
                    scrollTop > 50 ? 'rgba(255, 255, 255, 0.98)' : 'rgba(255, 255, 255, 0.95)';
    ...
    document.querySelectorAll('.service-card, .coverage-text, .contact-info, .contact-form')
        .forEach(el => {
...
class CookieManager {
    ...
    saveCustomSettings(accept) {
        const functional = document.querySelector('[data-category="functional"]').classList.contains('active');
        const analytics = document.querySelector('[data-category="analytics"]').classList.contains('active');
        const marketing = document.querySelector('[data-category="marketing"]').classList.contains('active');
